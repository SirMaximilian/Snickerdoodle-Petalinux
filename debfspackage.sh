...
petalinux-package --wic --wks rootfs.wks --rootfs-file debrootfs.tar.gz --outdir /home/tasker/Share --extra-bootfiles "image.ub system.dtb system.bit boot.scr uImage"